...
const FaqPage: React.FC = () => {
  ...
  return (
    <PageWrapper title={t.faqPage.title}>
      <p className="mb-8">{t.faqPage.intro}</p>
      <div className="space-y-4">
        <FaqItem question={t.faqPage.faqs.q1}>
          <p dangerouslySetInnerHTML={{ __html: t.faqPage.faqs.a1 }} />
        </FaqItem>
        <FaqItem question={t.faqPage.faqs.q2}>
          <p dangerouslySetInnerHTML={{ __html: t.faqPage.faqs.a2 }} />
        </FaqItem>
        <FaqItem question={t.faqPage.faqs.q3}>
          <p>{t.faqPage.faqs.a3}</p>
        </FaqItem>
        <FaqItem question={t.faqPage.faqs.q4}>
          <p>{t.faqPage.faqs.a4}</p>
        </FaqItem>
      </div>
    </PageWrapper>
  );
