...
const GalleryPage: React.FC = () => {
  ...
  const images = [
    { src: 'https://picsum.photos/600/400?random=40', alt: g.alts.img1 },
    { src: 'https://picsum.photos/600/400?random=41', alt: g.alts.img2 },
    { src: 'https://picsum.photos/600/400?random=42', alt: g.alts.img3 },
    { src: 'https://picsum.photos/600/400?random=43', alt: g.alts.img4 },
    { src: 'https://picsum.photos/600/400?random=44', alt: g.alts.img5 },
    { src: 'https://picsum.photos/600/400?random=45', alt: g.alts.img6 },
    { src: 'https://picsum.photos/600/400?random=46', alt: g.alts.img7 },
    { src: 'https://picsum.photos/600/400?random=47', alt: g.alts.img8 },
    { src: 'https://picsum.photos/600/400?random=48', alt: g.alts.img9 },
  ];
  ...
  return (
    <PageWrapper title={g.title}>
      <p className="mb-12">{g.intro}</p>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {images.map((image, index) => (
          <div key={index} className="overflow-hidden rounded-lg shadow-md group cursor-pointer" onClick={() => openLightbox(index)}>
            <img 
              src={image.src} 
              alt={image.alt}
