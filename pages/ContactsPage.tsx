  ...
  const mapMarkers = [
    {
      ...
      info: `
        <div style="padding: 8px; max-width: 250px;">
          <h3 style="margin: 0 0 8px 0; color: #40E0D0; font-weight: bold;">${c.title}</h3>
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-xl font-semibold text-brand-blue-dark mb-2 flex items-center">
              <svg className="w-6 h-6 mr-3 text-brand-gold font-bold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
              {c.address.title}
            </h3>
          ...
          <div>
            <h3 className="text-xl font-semibold text-brand-blue-dark mb-2 flex items-center">
                <svg className="w-6 h-6 mr-3 text-brand-gold font-bold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                {c.email.title}
            </h3>
          ...
          <div>
            <h3 className="text-xl font-semibold text-brand-blue-dark mb-2 flex items-center">
              <svg className="w-6 h-6 mr-3 text-brand-gold font-bold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
              {c.workTime.title}
            </h3>
