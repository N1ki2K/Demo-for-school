      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="space-y-6">
          <div>
            ...
            <EditableText
              id="address-line1"
              defaultContent={c.address.line1}
              tag="p"
            />
            <EditableText
              id="address-line2"
              defaultContent={c.address.line2}
              tag="p"
            />
          </div>
           <div>
           ...
           <div>
            ...
            <p><a href="mailto:contact@kganchev-school.bg" className="text-brand-blue-light hover:underline">
        ...
        <div>
           <div className="bg-gray-200 rounded-lg shadow-md h-96 flex items-center justify-center relative overflow-hidden">
                <EditableImage
                  id="contact-map"
                  defaultSrc="https://picsum.photos/600/400?random=100"
                  alt="Map location"
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-20">
                  <EditableText
                    id="map-placeholder"
                    defaultContent={c.map.placeholder}
                    tag="p"
                    className="text-white font-semibold text-lg bg-black bg-opacity-50 px-4 py-2 rounded"
                  />
                </div>
           </div>
        </div>
